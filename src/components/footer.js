...
function Footer({ className, logoImage, ...rest }) {
      ...
      <Container maxWidth="lg">
        <Grid container component="dl">
          <Grid item xs={12} md={4} className={classes.extraMarginTop}>
            <Logo className={classes.logo} logoImage={logoImage}/>
          </Grid>
          <Grid item xs={12} md={4} className={classes.extraMarginTop}>
          ...
          <Grid item xs={12} md={2} className={classes.extraMarginTop}>
            ...
            <Grid item xs={3} md={3} className={classes.extraMargin}>
              <List style={flexContainer}>
                ...
                >
                  <ListItemIcon className={classes.iconSocialMedia}>
                    <FontAwesomeIcon icon={['far', 'twitter']} size="lg" />
                  </ListItemIcon>
                </ListItem>
                <ListItem
                  className={classes.centerCls}
                ...
                >
                  <ListItemIcon className={classes.iconSocialMedia}>
                    <FontAwesomeIcon icon={['far', 'instagram']} size="lg" />
                  </ListItemIcon>
                </ListItem>
                <ListItem
                  className={classes.centerCls}
                ...
                >
                  <ListItemIcon className={classes.iconSocialMedia}>
                    <FontAwesomeIcon icon={['far', 'youtube']} size="lg" />
                  </ListItemIcon>
                </ListItem>
                <ListItem
                  className={classes.centerCls}
                ...
                >
                  <ListItemIcon className={classes.iconSocialMedia}>
                    <FontAwesomeIcon icon={['far', 'linkedin']} size="lg" />
                  </ListItemIcon>
                </ListItem>
              </List>
            </Grid>
